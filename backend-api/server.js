...
// ** CONFIGURACIÓN DE CORS AJUSTADA **
// Ahora usamos la URL específica de tu frontend desplegado en Render.
// Esto es más seguro que usar '*' y es la causa más probable de tu error "No se pudo conectar con el servidor".
app.use(cors({
    origin: 'https://kinal-frontend-site.onrender.com' // <-- ¡USAR LA URL ESPECÍFICA DE TU FRONTEND EN RENDER!
    // Si quisieras permitir también tu localhost para pruebas locales (ej. puerto 3000 o 8080):
    // origin: ['https://kinal-frontend-site.onrender.com', 'http://localhost:3000']
    // Si tu frontend envía cookies o encabezados de autorización, podrías necesitar:
    // credentials: true
}));
...
// ** Nueva Ruta Raíz para verificar el Backend (recomendado) **
// Cuando visites https://proyectoexpkinal.onrender.com/, verás este mensaje.
app.get('/', (req, res) => {
    res.send('¡El backend de la API de Kinal está funcionando correctamente!');
});

// Iniciar el servidor
app.listen(port, () => {
    console.log(`Servidor backend escuchando en el puerto ${port}`);
    console.log('Intentando conexión a PostgreSQL...');
